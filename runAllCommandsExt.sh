...
./bin/parseFiresRateFile.exe input/keepTriggersExtList.txt  outDir/accept_Run$1.txt

#./bin/parseFiresRateFile.exe input/keepTriggersCoreList.txt outDir/avg_prescale_Run285517.txt
./bin/parseFiresRateFile.exe input/keepTriggersExtList.txt outDir/avg_prescale_Run$1.txt

#compile next script
sh compileWithRoot.sh src/triggerParseTreeHist.C
#execute
./bin/triggerParseTreeHist.exe outParseDir/ input/keepTriggersExtList.txt
